...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (employeeParam) {
      ...
      // Refresh settings before handling URL employee parameter
  ...
  const handleSearch = async () => {
    ...
    // Refresh company settings before search
