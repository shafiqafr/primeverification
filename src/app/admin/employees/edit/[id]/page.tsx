  ...
  const fetchEmployee = async () => {
    try {
      ...
      setFormData({
        ...
        status: emp.status,
        issueDate: emp.issueDate.split('T')[0],
        expiryDate: emp.expiryDate.split('T')[0],
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <Card className="w-full max-w-md">
          <CardContent className="p-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Employee Updated Successfully!</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-4">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <h1 className="text-2xl font-bold text-blue-800">Edit Employee</h1>
                <p className="text-sm text-gray-600">Update employee information and details</p>
              </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex gap-4 pt-6">
                    <Button
                      type="submit"
                      disabled={loading}
                      className="flex-1 bg-gradient-to-r from-orange-600 to-orange-800 hover:from-orange-700 hover:to-orange-900 text-white h-12 text-lg font-semibold"
                    >
                      {loading ? (
              ...
              <CardContent className="p-6">
                <div className="space-y-6">
                  ...
                  <Button
                    ...
                    className="w-full bg-gradient-to-r from-purple-600 to-purple-800 hover:from-purple-700 hover:to-purple-900 text-white h-12 font-semibold"
                  >
                  ...
                  <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                    ...
                    <p className="text-sm text-purple-800">
                      This is a live preview of the employee card. As you edit the form, the preview updates in real-time. 
                      All changes will be saved when you click "Update Employee".
                    </p>
                  </div>
                </div>
              </CardContent>
